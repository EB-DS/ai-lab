...
from retriever_rerank import load_chunks, build_embeddings, build_reranker, retrieve

PROJECT_DIR = Path(__file__).resolve().parents[1]
QUESTIONS_FILE = PROJECT_DIR / "data" / "evaluation" / "retrieval_hard_questions.csv"
...
def evaluate() -> None:
    ...
    for item in questions:
        ...
        relevant_chunk_ids = set(item["relevant_chunk_ids"].split(";"))
        ...
        print(
            f"{item['question_id']} | "
            f"relevant={item['relevant_chunk_ids']} | "
